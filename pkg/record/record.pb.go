...
func (x *MatchHeader) GetLayerId() string {
	if x != nil {
		return x.LayerId
	}
	return ""
...
const file_pkg_record_record_proto_rawDesc = "" +
	...
	"\bclan_tag\x18\x05 \x01(\tR\aclanTag\"\xd8\x02\n" +
	...
	"\aplayers\x18\x05 \x03(\v2 .record.MatchHeader.PlayersEntryR\aplayers\x12\x19\n" +
	"\blayer_id\x18\x06 \x01(\tR\alayerId\x1aO\n" +
